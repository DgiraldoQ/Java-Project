Este proyecto consiste en el desarrollo de una aplicación de escritorio en Java, orientada a objetos, que permite a usuarios gestionar de forma eficiente sus finanzas personales o empresariales.
